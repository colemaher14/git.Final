...
pacman::p_load(janitor, VIM, odds.n.ends, blorr, haven, lmtest, broom, tidyverse, 
               jtools, ggeffects, emmeans, gtsummary, gt, table1, DiagrammeR, mice) 
...
df1 <- read_xpt('/Users/colemaher/Desktop/LLCP2024.XPT ') %>%
...
confounding_plot <- confounding_assessment %>%
  ...
  labs(
    ...
    subtitle = "Red dashed lines indicate ±10% threshold for meaningful confounding",
    x = "Age Group",
...
gtsave(as_gt(table1), "table1.html")
```
